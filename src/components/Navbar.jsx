      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-5 md:px-6 lg:px-8 py-1">
          <div className="flex flex-nowrap justify-between items-center h-16 sm:h-14 lg:h-14 min-h-[56px] gap-x-2">
            ...
            >
              <span className="block text-2xl xs:text-[26px] sm:hidden font-extrabold text-cyan-400 bg-clip-text text-transparent drop-shadow-lg tracking-wide font-[Poppins] leading-tight">
                SAINT Devs
              </span>
              <span className="hidden sm:block text-2xl sm:text-[26px] md:text-[30px] lg:text-[32px] font-extrabold text-cyan-400 bg-clip-text text-transparent drop-shadow-lg tracking-wide font-[Poppins] leading-tight truncate max-w-[68vw]">
                SAINT Develops
              </span>
            </Motion.div>
